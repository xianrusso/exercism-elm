...
var $author$project$Pangram$regex = A2(
	$elm$core$Maybe$withDefault,
...
var $author$project$Pangram$isPangram = function (sentence) {
	var list = $elm$core$String$toList(
		$elm$core$String$toLower(
			A3(
				$elm$regex$Regex$replace,
				$author$project$Pangram$regex,
				function (_v0) {
					return '';
				},
				sentence)));
	var set = $elm$core$Set$fromList(list);
	return $elm$core$Set$size(set) === 26;
};
		...
		[
			...
			function (_v0) {
				return A2(
					...
					false,
					$author$project$Pangram$isPangram(''));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					true,
					$author$project$Pangram$isPangram('the quick brown fox jumps over the lazy dog'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'missing character \'x\'',
			function (_v2) {
				return A2(
					$elm_explorations$test$Expect$equal,
					false,
					$author$project$Pangram$isPangram('a quick movement of the enemy will jeopardize five gunboats'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'missing character \'z\'',
			function (_v3) {
				return A2(
					$elm_explorations$test$Expect$equal,
					false,
					$author$project$Pangram$isPangram('a quick movement of the enemy will jeopardixe five gunboats'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v4) {
				return A2(
					$elm_explorations$test$Expect$equal,
					false,
					$author$project$Pangram$isPangram('the quick brown fish jumps over the lazy dog'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v5) {
				return A2(
					$elm_explorations$test$Expect$equal,
					true,
					$author$project$Pangram$isPangram('the_quick_brown_fox_jumps_over_the_lazy_dog'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v6) {
				return A2(
					$elm_explorations$test$Expect$equal,
					true,
					$author$project$Pangram$isPangram('the 1 quick brown fox jumps over the 2 lazy dogs'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v7) {
				return A2(
					$elm_explorations$test$Expect$equal,
					false,
					$author$project$Pangram$isPangram('7h3 qu1ck brown fox jumps ov3r 7h3 lazy dog'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v8) {
				return A2(
					$elm_explorations$test$Expect$equal,
					true,
					$author$project$Pangram$isPangram('\"Five quacking Zephyrs jolt my wax bed.\"'));
			}),
			A2(
			$elm_explorations$test$Test$test,
...
var $author$project$Test$Generated$Main2574055291$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['C:\\Users\\xian\\Exercism\\elm\\pangram\\tests\\Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 292571822740383
	},
...
_Platform_export({'Test':{'Generated':{'Main2574055291':{'init':$author$project$Test$Generated$Main2574055291$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "\\\\.\\pipe\\elm_test-31760-1";
