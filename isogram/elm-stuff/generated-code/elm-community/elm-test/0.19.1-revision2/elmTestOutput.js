...
var $author$project$Isogram$regex = A2(
	$elm$core$Maybe$withDefault,
	$elm$regex$Regex$never,
	$elm$regex$Regex$fromString('[^a-zA-Z]+'));
var $elm$regex$Regex$replace = _Regex_replaceAtMost(_Regex_infinity);
var $elm$core$String$toLower = _String_toLower;
var $author$project$Isogram$isIsogram = function (sentence) {
	var newSentence = $elm$core$String$toLower(
		A3(
			$elm$regex$Regex$replace,
			$author$project$Isogram$regex,
			function (_v0) {
				return '';
			},
			sentence));
	var set = $elm$core$Set$fromList(
		$elm$core$String$toList(newSentence));
	var list = A2(
		$elm$core$List$map,
		function (x) {
	...
	return _Utils_eq(
		len,
		$elm$core$String$length(newSentence)) ? true : false;
};
		...
		[
			...
			function (_v0) {
				return A2(
					...
					true,
					$author$project$Isogram$isIsogram(''));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					true,
					$author$project$Isogram$isIsogram('isogram'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v2) {
				return A2(
					$elm_explorations$test$Expect$equal,
					false,
					$author$project$Isogram$isIsogram('eleven'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v3) {
				return A2(
					$elm_explorations$test$Expect$equal,
					true,
					$author$project$Isogram$isIsogram('subdermatoglyphic'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v4) {
				return A2(
					$elm_explorations$test$Expect$equal,
					false,
					$author$project$Isogram$isIsogram('Alphabet'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v5) {
				return A2(
					$elm_explorations$test$Expect$equal,
					true,
					$author$project$Isogram$isIsogram('thumbscrew-japingly'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'isogram with duplicated non letter character',
			function (_v6) {
				return A2(
					$elm_explorations$test$Expect$equal,
					true,
					$author$project$Isogram$isIsogram('Hjelmqvist-Gryb-Zock-Pfund-Wax'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v7) {
				return A2(
					$elm_explorations$test$Expect$equal,
					true,
					$author$project$Isogram$isIsogram('Emily Jung Schwartzkopf'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v8) {
				return A2(
					$elm_explorations$test$Expect$equal,
					false,
					$author$project$Isogram$isIsogram('accentor'));
			})
		]));
var $author$project$Test$Generated$Main2936539827$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['C:\\Users\\xian\\Exercism\\elm\\isogram\\tests\\Tests.elm']),
		processes: 8,
...
_Platform_export({'Test':{'Generated':{'Main2936539827':{'init':$author$project$Test$Generated$Main2936539827$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "\\\\.\\pipe\\elm_test-23504-1";
