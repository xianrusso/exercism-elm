...
var $author$project$Bob$isQuestion = function (str) {
...
var $author$project$Bob$regex = A2(
	$elm$core$Maybe$withDefault,
	$elm$regex$Regex$never,
	$elm$regex$Regex$fromString('[a-zA-Z]+'));
var $author$project$Bob$isWord = function (str) {
	return A2($elm$regex$Regex$contains, $author$project$Bob$regex, str);
};
var $elm$core$String$toUpper = _String_toUpper;
var $author$project$Bob$isYelling = function (str) {
	return _Utils_eq(
		$elm$core$String$toUpper(str),
		str);
};
var $author$project$Bob$hey = function (remark) {
	var str = $elm$core$String$trim(remark);
	return ($author$project$Bob$isYelling(str) && ($author$project$Bob$isQuestion(str) && $author$project$Bob$isWord(str))) ? 'Calm down, I know what I\'m doing!' : (($author$project$Bob$isYelling(str) && $author$project$Bob$isWord(str)) ? 'Whoa, chill out!' : ($author$project$Bob$isQuestion(str) ? 'Sure.' : ($elm$core$String$isEmpty(
		$elm$core$String$trim(str)) ? 'Fine. Be that way!' : 'Whatever.')));
};
...
var $author$project$Test$Generated$Main4227367509$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['C:\\Users\\xian\\Exercism\\elm\\bob\\tests\\Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 360059148656296
	},
...
_Platform_export({'Test':{'Generated':{'Main4227367509':{'init':$author$project$Test$Generated$Main4227367509$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "\\\\.\\pipe\\elm_test-32608-1";
